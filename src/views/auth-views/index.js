  ...
  return (
    <Suspense fallback={<Loading cover="page"/>}>
      <Switch>
        ...
        <Route path={`${AUTH_PREFIX_PATH}/reset-passsword`} component={lazy(() => import(`./authentication/forgot-password`))} />
        <Route path={`${AUTH_PREFIX_PATH}/confirm-password-reset/:uid/:token`} component={lazy(() => import(`./authentication/reset-password`))} />
